...
export const AnimatedWordBlock = forwardRef<HTMLDivElement, AnimatedWordBlockProps>(
  function AnimatedWordBlock({ wordAbove, wordBelow }, ref) {
    ...
    return (
      <span
        ...
        className="flex flex-col overflow-hidden leading-[3rem] relative">
