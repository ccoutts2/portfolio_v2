...
const PreLoader = () => {
  ...
  return (
    <div ref={container} className="overflow-hidden opacity-0">
      <div className="fixed top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 overflow-hidden text-white z-[1000]">
        <p ref={textRef}>say hello</p>
      </div>
      <div
        ref={backgroundLoader}
        className="fixed inset-0 z-[999] flex justify-center items-center h-screen bg-black"
      ></div>
    </div>
  );
};
