      ...
      <nav
        ...
        <div className="flex-[2] md:flex-[1] flex justify-end items-center border-solid">
          <ul className="flex md:flex-col items-stretch border-r border-l border-solid">
            <li className="p-4 border-r md:border-b md:border-r-0 border-solid hover:bg-[#435558] hover:duration-200">
              <span>
                <NavLink href="/">
                  <Icon>
                    <svg
            ...
            <li className="p-4 hover:bg-[#435558] hover:duration-200">
              <span>
                <NavLink href="/">
                  <Icon>
                    <svg
